...
export default function Users() {
    ...
    const fetchUsers = async () => {
        try {
            const res = await axios.get("https://enhanced-indian-railways.onrender.com/api/users");
            console.log(res)
            if (res.data.success) {
                setUsers(res.data.users);
            }
            const res1 = await axios.get("https://enhanced-indian-railways.onrender.com/api/get-user-and-role", {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const res = await axios.post("https://enhanced-indian-railways.onrender.com/api/add-user", formData);
            if (res.data.success) {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const res = await axios.get(`https://enhanced-indian-railways.onrender.com/api/users/${id}`, {
                withCredentials: true
            });
            if (res.data.success) {
